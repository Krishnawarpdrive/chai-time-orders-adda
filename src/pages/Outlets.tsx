    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="bg-white border-b border-gray-200 p-4 flex justify-between items-center sticky top-0 z-40">
          <h1 className="font-hackney text-2xl text-coffee-green">Franchise Management</h1>
        ...
        <main className="flex-1 p-6 bg-milk-sugar overflow-y-auto">
          <div className="max-w-7xl mx-auto">
            <div className="mb-6">
              <h2 className="font-hackney text-3xl text-coffee-green mb-1">Franchise Outlets</h2>
              <p className="text-gray-600 text-sm">Monitor and manage performance across all franchise outlets</p>
            </div>
